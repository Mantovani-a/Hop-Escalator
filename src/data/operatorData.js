...
export const operatorOccurrenceMetadata = {
  ...
  'OCC-2026-002': {
    ...
    diagnosis: { demoCode: 'MVP-TR-004', system: 'Tração', source: 'Telemetria simulada do equipamento', probableOrigin: 'Conjunto de tração', suspectedRegions: ['machine', 'pulleys', 'belts'], summary: 'Possível indisponibilidade no conjunto superior. Confirmar cabos, polias e máquina de tração no local.' },
  },
  'OCC-2026-003': {
    ...
    diagnosis: { demoCode: 'MVP-PT-021', system: 'Portas', source: 'Detecção automática simulada do equipamento', probableOrigin: 'Sistema de portas', suspectedRegions: ['doors', 'doorOperator', 'sensors'], summary: 'Possível falha no ciclo de fechamento ou na leitura do sensor da porta.' },
  },
  'OCC-2026-005': {
    ...
    diagnosis: { demoCode: 'MVP-EL-012', system: 'Painel de controle', source: 'Telemetria simulada do equipamento', probableOrigin: 'Painel de controle', suspectedRegions: ['control', 'sensors'], summary: 'Possível interrupção no processamento da chamada do pavimento. Necessária verificação local.' },
  },
  'OCC-2026-007': {
    ...
    diagnosis: { demoCode: 'MVP-SN-008', system: 'Sensores', source: 'Detecção automática simulada do equipamento', probableOrigin: 'Sensor de comando', suspectedRegions: ['sensors', 'control'], summary: 'Possível leitura intermitente entre o painel e os sensores de comando.' },
  },
  'OCC-SIM-001': {
    ...
    diagnosis: { demoCode: 'MVP-PT-028', system: 'Portas', source: 'Detecção automática simulada do equipamento', probableOrigin: 'Sistema de portas', suspectedRegions: ['doors', 'doorOperator', 'sensors'], summary: 'Possível falha no travamento ou na leitura do conjunto de portas.' },
  },
  'OCC-SIM-002': {
    ...
    diagnosis: { demoCode: 'MVP-CB-011', system: 'Cabos e polias', source: 'Telemetria simulada do equipamento', probableOrigin: 'Conjunto de cabos de tração', suspectedRegions: ['belts', 'pulleys', 'machine'], summary: 'Possível desgaste ou desalinhamento nos cabos e polias de tração. Verificar tensão e alinhamento no local.' },
  },
  'OCC-SIM-003': {
  ...
  'OCC-SIM-004': {
    ...
    diagnosis: { demoCode: 'MVP-QC-015', system: 'Quadro de controle', source: 'Telemetria simulada do equipamento', probableOrigin: 'Painel de controle e sensores', suspectedRegions: ['control', 'sensors', 'buffers'], summary: 'Possível falha de comunicação entre painel de controle e sensores. Verificar conexões e módulos no local.' },
  },
};
