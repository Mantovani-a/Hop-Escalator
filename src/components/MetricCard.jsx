export default function MetricCard({ label, value, detail, tone = 'default' }) {
  return (
    <article className="position-relative bg-white border rounded p-4 overflow-hidden" style={{ minWidth: 0 }}>
      ...
      <strong className="d-block my-2 text-dark" style={{ fontSize: 'clamp(1.55rem, 6vw, 2.15rem)', lineHeight: 1 }}>{value}</strong>
