          ...
          <div className="col-12 col-sm-6 col-lg-4 col-xl-3" key={elevator.id}>
            ...
            >
              <header className="d-flex flex-wrap align-items-start justify-content-between gap-3 mb-4">
                <p className="text-primary fw-bold text-uppercase mb-0" style={{ fontSize: '0.75rem', letterSpacing: '0.08em', lineHeight: 1.45 }}>{elevator.client?.name || 'Cliente Corporativo'}</p>
              ...
              <dl className="d-grid gap-3 pt-4 border-top m-0">
                <div><dt className="text-secondary fw-bold text-uppercase mb-1" style={{ fontSize: '0.7rem' }}>Última manutenção</dt><dd className="fw-bold mb-0" style={{ color: 'var(--color-text)', fontSize: '0.84rem' }}>{elevator.lastMaintenance ? formatDate(elevator.lastMaintenance) : 'Recente'}</dd></div>
