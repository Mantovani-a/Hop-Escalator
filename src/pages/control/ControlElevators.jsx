      ...
      <section className="row g-4 mt-2">
        {elevators.map((elevator) => (
          <div className="col-12 col-sm-6 col-lg-4 col-xl-3" key={elevator.id}>
            <article
              className="app-card border rounded shadow-sm p-4 d-flex flex-column"
            ...
            >
              ...
              <div className="mb-4 flex-grow-1">
                <h2 className="fs-5 mb-1" style={{ color: 'var(--color-text)', fontWeight: 750, lineHeight: 1.35 }}>{elevator.identification}</h2>
              ...
              <dl className="d-grid gap-3 pt-4 border-top m-0">
                <div><dt className="text-secondary fw-bold text-uppercase mb-1" style={{ fontSize: '0.7rem' }}>Última manutenção</dt><dd className="fw-bold mb-0" style={{ color: 'var(--color-text)', fontSize: '0.84rem' }}>{formatDate(elevator.lastMaintenance)}</dd></div>
                ...
                <div><dt className="text-secondary fw-bold text-uppercase mb-1" style={{ fontSize: '0.7rem' }}>Ocorrências recentes</dt><dd className="fw-bold mb-0" style={{ color: 'var(--color-text)', fontSize: '0.84rem' }}>{elevator.recentOccurrenceCount}</dd></div>
              </dl>
              {elevator.recurrent && (
